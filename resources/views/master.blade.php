...
<html class=" ">
    <head>
        ...
        <link rel="shortcut icon" href="dashboard/assets/images/favicon.png" type="image/x-icon" />    <!-- Favicon -->
    ...
    <body class=" "><!-- START TOPBAR -->
                                ...
                                <li class="list dropdown-item">
                                    ...
                                    <ul class="dropdown-menu-list list-unstyled ps-scrollbar">
                                        <li class="unread status-available">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="dashboard/data/profile/avatar-1.png" alt="user-image" class="rounded-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-away">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="dashboard/data/profile/avatar-2.png" alt="user-image" class="rounded-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-busy">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="dashboard/data/profile/avatar-3.png" alt="user-image" class="rounded-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-offline">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="dashboard/data/profile/avatar-4.png" alt="user-image" class="rounded-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-offline">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="dashboard/data/profile/avatar-5.png" alt="user-image" class="rounded-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                ...
                <div class='float-right'>
                    <ul class="info-menu right-links list-inline list-unstyled">
                        <li class="profile list-inline-item">
                            <a href="#" data-toggle="dropdown" class="toggle">
                                <img src="dashboard/data/profile/profile.png" alt="user-image" class="rounded-circle img-inline">
                    ...
                    <div class="profile-info row">
                        ...
                        <div class="profile-image col-lg-4 col-md-4 col-4">
                            <a href="ui-profile.html">
                                <img src="dashboard/data/profile/profile.png" class="img-fluid rounded-circle">
                            </a>
                        </div>
        ...
        <script src="dashboard/assets/js/jquery-3.4.1.min.js" type="text/javascript"></script> 
        <script src="dashboard/assets/js/popper.min.js" type="text/javascript"></script> 
        <!-- <script src="dashboard/assets/js/jquery.easing.min.js" type="text/javascript"></script>  -->
        <script src="dashboard/assets/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script> 
        <script src="dashboard/assets/plugins/pace/pace.min.js" type="text/javascript"></script>  

        <script src="dashboard/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js" type="text/javascript"></script> 
        <script src="dashboard/assets/plugins/viewport/viewportchecker.js" type="text/javascript"></script>  
        <!-- CORE JS FRAMEWORK - END --> 


        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="dashboard/assets/plugins/jquery-ui/smoothness/jquery-ui.min.js" type="text/javascript"></script> <script src="dashboard/assets/plugins/sparkline-chart/jquery.sparkline.min.js" type="text/javascript"></script><script src="dashboard/assets/plugins/easypiechart/jquery.easypiechart.min.js" type="text/javascript"></script><script src="dashboard/assets/plugins/morris-chart/js/raphael-min.js" type="text/javascript"></script><script src="dashboard/assets/plugins/morris-chart/js/morris.min.js" type="text/javascript"></script><script src="dashboard/assets/plugins/jvectormap/jquery-jvectormap-2.0.1.min.js" type="text/javascript"></script><script src="dashboard/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script><script src="dashboard/assets/plugins/gauge/gauge.min.js" type="text/javascript"></script><script src="dashboard/assets/plugins/icheck/icheck.min.js" type="text/javascript"></script><script src="dashboard/assets/js/dashboard.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 


        <!-- CORE TEMPLATE JS - START --> 
        <script src="dashboard/assets/js/scripts.js" type="text/javascript"></script> 
        <!-- END CORE TEMPLATE JS - END --> 

        <!-- Sidebar Graph - START --> 
        <script src="dashboard/assets/plugins/sparkline-chart/jquery.sparkline.min.js" type="text/javascript"></script>
        <script src="dashboard/assets/js/chart-sparkline.js" type="text/javascript"></script>
        <!-- Sidebar Graph - END --> 
